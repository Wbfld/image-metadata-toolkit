/** Small dependency-free SHA-256 implementation used for transactional
 * evidence in browser and server runtimes. It never mutates the input. */
...
/** Synchronous SHA-256 used by bounded, synchronous writer verification. */
